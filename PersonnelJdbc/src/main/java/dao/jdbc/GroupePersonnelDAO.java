...
public class GroupePersonnelDAO extends DAO <Personnel>  {
	...
	public GroupePersonnelDAO(String nomBase,String repertoireBase) {
	...
	public static void main(String[] args) throws Exception {
		...
		GroupePersonnelDAO daoPersonnel = new GroupePersonnelDAO("usersdb", "/home/devc/tools/derby/");
